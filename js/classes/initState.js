...
export let initialState = {
    ...
    canStart: 0,
    phase: false,   // фаза игры подготовка или игра(preparation / game)
    countUnitId: 0,         // текущий ID юнитов
    squadId: 100,           // текущий ID отрядов
    exUnitId: 100,
    left: 96,              // для авт. подбора положения создания нового отряда
    top: 64,               // для авт. подбора положения создания нового отряда
    moveLeft: 0,            // для перетаскивания, временные координаты
    moveTop: 0,             // для перетаскивания, временные координаты
    showUnitInfo: 0,       // 0 или 1 показываем не показываем
    curExUnit: '',
